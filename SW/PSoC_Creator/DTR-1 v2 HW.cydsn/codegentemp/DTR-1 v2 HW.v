...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967294, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Millis, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Millis, CY_INSTANCE_SHORT_NAME=Millis, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Millis, )
...
module top ;
    ...
    CyStatusReg_v1_90 RCM (
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(datain[7:0]));
    defparam RCM.Bit0Mode = 1;
    defparam RCM.Bit1Mode = 1;
    defparam RCM.Bit2Mode = 1;
    defparam RCM.Bit3Mode = 1;
    defparam RCM.Bit4Mode = 1;
    defparam RCM.Bit5Mode = 1;
    defparam RCM.Bit6Mode = 1;
    defparam RCM.Bit7Mode = 1;
    defparam RCM.BusDisplay = 1;
    defparam RCM.Interrupt = 0;
    defparam RCM.MaskValue = 0;
    defparam RCM.NumInputs = 8;

	wire [7:0] tmpOE__AddrH_net;
	wire [7:0] tmpIO_7__AddrH_net;
	wire [0:0] tmpINTERRUPT_0__AddrH_net;
	electrical [0:0] tmpSIOVREF__AddrH_net;
	...
	cy_psoc3_pins_v1_10
		...
		AddrH
		 (.oe(tmpOE__AddrH_net),
		  .y({8'b0}),
		  .fb({adh[7:0]}),
		  .io({tmpIO_7__AddrH_net[7:0]}),
		  .siovref(tmpSIOVREF__AddrH_net),
		  .interrupt({tmpINTERRUPT_0__AddrH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AddrH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};


    assign Net_305 = ~adl[7];

	wire [0:0] tmpOE__MR_net;
	wire [0:0] tmpIO_0__MR_net;
	wire [0:0] tmpINTERRUPT_0__MR_net;
	electrical [0:0] tmpSIOVREF__MR_net;
	...
	cy_psoc3_pins_v1_10
		...
		MR
		 (.oe(tmpOE__MR_net),
		  .y({1'b0}),
		  .fb({Net_139}),
		  .io({tmpIO_0__MR_net[0:0]}),
		  .siovref(tmpSIOVREF__MR_net),
		  .interrupt({tmpINTERRUPT_0__MR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MW_net;
	wire [0:0] tmpIO_0__MW_net;
	wire [0:0] tmpINTERRUPT_0__MW_net;
	...
	cy_psoc3_pins_v1_10
		...
		MW
		 (.oe(tmpOE__MW_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__MW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_448 = ~adl[6];

	wire [0:0] tmpOE__IOW_net;
	wire [0:0] tmpIO_0__IOW_net;
	wire [0:0] tmpINTERRUPT_0__IOW_net;
	electrical [0:0] tmpSIOVREF__IOW_net;
	...
	cy_psoc3_pins_v1_10
		...
		IOW
		 (.oe(tmpOE__IOW_net),
		  .y({1'b0}),
		  .fb({Net_336}),
		  .io({tmpIO_0__IOW_net[0:0]}),
		  .siovref(tmpSIOVREF__IOW_net),
		  .interrupt({tmpINTERRUPT_0__IOW_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IOW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTL_net;
	wire [0:0] tmpFB_0__RTL_net;
	wire [0:0] tmpIO_0__RTL_net;
	wire [0:0] tmpINTERRUPT_0__RTL_net;
	electrical [0:0] tmpSIOVREF__RTL_net;
	...
	cy_psoc3_pins_v1_10
		...
		RTL
		 (.oe(tmpOE__RTL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTL_net[0:0]}),
		  .io({tmpIO_0__RTL_net[0:0]}),
		  .siovref(tmpSIOVREF__RTL_net),
		  .interrupt({tmpINTERRUPT_0__RTL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RES_net;
	wire [0:0] tmpFB_0__RES_net;
	wire [0:0] tmpIO_0__RES_net;
	wire [0:0] tmpINTERRUPT_0__RES_net;
	electrical [0:0] tmpSIOVREF__RES_net;
	...
	cy_psoc3_pins_v1_10
		...
		RES
		 (.oe(tmpOE__RES_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RES_net[0:0]}),
		  .io({tmpIO_0__RES_net[0:0]}),
		  .siovref(tmpSIOVREF__RES_net),
		  .interrupt({tmpINTERRUPT_0__RES_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RES_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WE_net;
	wire [0:0] tmpFB_0__WE_net;
	wire [0:0] tmpIO_0__WE_net;
	wire [0:0] tmpINTERRUPT_0__WE_net;
	electrical [0:0] tmpSIOVREF__WE_net;
	...
	cy_psoc3_pins_v1_10
		...
		WE
		 (.oe(tmpOE__WE_net),
		  .y({Net_203[1]}),
		  .fb({tmpFB_0__WE_net[0:0]}),
		  .io({tmpIO_0__WE_net[0:0]}),
		  .siovref(tmpSIOVREF__WE_net),
		  .interrupt({tmpINTERRUPT_0__WE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MSEL_net;
	wire [0:0] tmpFB_0__MSEL_net;
	wire [0:0] tmpIO_0__MSEL_net;
	wire [0:0] tmpINTERRUPT_0__MSEL_net;
	electrical [0:0] tmpSIOVREF__MSEL_net;
	...
	cy_psoc3_pins_v1_10
		...
		MSEL
		 (.oe(tmpOE__MSEL_net),
		  .y({Net_203[0]}),
		  .fb({tmpFB_0__MSEL_net[0:0]}),
		  .io({tmpIO_0__MSEL_net[0:0]}),
		  .siovref(tmpSIOVREF__MSEL_net),
		  .interrupt({tmpINTERRUPT_0__MSEL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MSEL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OER_net;
	wire [0:0] tmpFB_0__OER_net;
	wire [0:0] tmpIO_0__OER_net;
	wire [0:0] tmpINTERRUPT_0__OER_net;
	electrical [0:0] tmpSIOVREF__OER_net;
	...
	cy_psoc3_pins_v1_10
		...
		OER
		 (.oe(tmpOE__OER_net),
		  .y({Net_203[2]}),
		  .fb({tmpFB_0__OER_net[0:0]}),
		  .io({tmpIO_0__OER_net[0:0]}),
		  .siovref(tmpSIOVREF__OER_net),
		  .interrupt({tmpINTERRUPT_0__OER_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OER_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__BUSAK_net;
	wire [0:0] tmpFB_0__BUSAK_net;
	wire [0:0] tmpIO_0__BUSAK_net;
	wire [0:0] tmpINTERRUPT_0__BUSAK_net;
	electrical [0:0] tmpSIOVREF__BUSAK_net;
	...
	cy_psoc3_pins_v1_10
		...
		BUSAK
		 (.oe(tmpOE__BUSAK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUSAK_net[0:0]}),
		  .io({tmpIO_0__BUSAK_net[0:0]}),
		  .siovref(tmpSIOVREF__BUSAK_net),
		  .interrupt({tmpINTERRUPT_0__BUSAK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUSAK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUSRQ_net;
	wire [0:0] tmpFB_0__BUSRQ_net;
	wire [0:0] tmpIO_0__BUSRQ_net;
	wire [0:0] tmpINTERRUPT_0__BUSRQ_net;
	electrical [0:0] tmpSIOVREF__BUSRQ_net;
	...
	cy_psoc3_pins_v1_10
		...
		BUSRQ
		 (.oe(tmpOE__BUSRQ_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUSRQ_net[0:0]}),
		  .io({tmpIO_0__BUSRQ_net[0:0]}),
		  .siovref(tmpSIOVREF__BUSRQ_net),
		  .interrupt({tmpINTERRUPT_0__BUSRQ_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUSRQ_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Counter_v3_0_3 Millis (
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Millis.CaptureMode = 0;
    defparam Millis.ClockMode = 0;
    defparam Millis.CompareMode = 1;
    defparam Millis.CompareStatusEdgeSense = 1;
    defparam Millis.EnableMode = 1;
    defparam Millis.ReloadOnCapture = 0;
    defparam Millis.ReloadOnCompare = 0;
    defparam Millis.ReloadOnOverUnder = 1;
    defparam Millis.ReloadOnReset = 1;
    defparam Millis.Resolution = 32;
    defparam Millis.RunMode = 0;
    defparam Millis.UseInterrupt = 1;
    ...
    cy_sync_v1_0 Sync_Millis (
        .clock(Net_70),
        .s_in(Net_102),
        .s_out(Net_99));
    defparam Sync_Millis.SignalWidth = 1;


    assign Net_144 = Net_139 & Net_142;


    assign Net_254[0] = Net_144 | Net_254[2];


    assign Net_254[1] = Net_142 | Net_254[2];


    assign Net_254[2] = adh[3] & adh[4] & adh[5] & adh[6] & adh[7];


    assign Net_282 = ~adl[3];


    assign Net_286 = ~adl[5];

    // -- Mux start --
    if (1)
    begin : mux_1
        reg [2:0] tmp__mux_1_reg;
        always @(Net_254 or Net_245 or Net_236)
        begin
            case (Net_236)
                1'b0 :  tmp__mux_1_reg = Net_254[2:0];
                1'b1 :  tmp__mux_1_reg = Net_245[2:0];
            endcase
        end
        assign Net_203[2:0] = tmp__mux_1_reg;
    end
    // -- Mux end --

    CyControlReg_v1_80 SRAM_Ctl (
        .clock(1'b0),
        .control_0(Net_245[0]),
        .control_1(Net_245[1]),
        .control_2(Net_245[2]),
        ...
        .control_7(Net_251),
        .reset(1'b0));
    defparam SRAM_Ctl.Bit0Mode = 0;
    defparam SRAM_Ctl.Bit1Mode = 0;
    defparam SRAM_Ctl.Bit2Mode = 0;
    defparam SRAM_Ctl.Bit3Mode = 0;
    defparam SRAM_Ctl.Bit4Mode = 0;
    defparam SRAM_Ctl.Bit5Mode = 0;
    defparam SRAM_Ctl.Bit6Mode = 0;
    defparam SRAM_Ctl.Bit7Mode = 0;
    defparam SRAM_Ctl.BitValue = 7;
    defparam SRAM_Ctl.BusDisplay = 0;
    defparam SRAM_Ctl.ExtrReset = 0;
    defparam SRAM_Ctl.NumOutputs = 5;


    assign Net_280 = ~adl[2];


    assign Net_343 = Net_280 & Net_282 & adl[4] & Net_286 & Net_448 & Net_305;

	wire [7:0] tmpOE__AddrL_net;
	wire [7:0] tmpIO_7__AddrL_net;
	wire [0:0] tmpINTERRUPT_0__AddrL_net;
	electrical [0:0] tmpSIOVREF__AddrL_net;
	...
	cy_psoc3_pins_v1_10
		...
		AddrL
		 (.oe(tmpOE__AddrL_net),
		  .y({8'b0}),
		  .fb({adl[7:0]}),
		  .io({tmpIO_7__AddrL_net[7:0]}),
		  .siovref(tmpSIOVREF__AddrL_net),
		  .interrupt({tmpINTERRUPT_0__AddrL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__AddrL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

    CyControlReg_v1_80 RSM (
        .clock(1'b0),
        .control_0(Net_313),
        .control_1(Net_314),
        .control_2(Net_315),
        ...
        .control_6(Net_319),
        .control_7(Net_320),
        .control_bus(Net_255[7:0]),
        .reset(1'b0));
    defparam RSM.Bit0Mode = 0;
    defparam RSM.Bit1Mode = 0;
    defparam RSM.Bit2Mode = 0;
    defparam RSM.Bit3Mode = 0;
    defparam RSM.Bit4Mode = 0;
    defparam RSM.Bit5Mode = 0;
    defparam RSM.Bit6Mode = 0;
    defparam RSM.Bit7Mode = 0;
    defparam RSM.BitValue = 0;
    defparam RSM.BusDisplay = 1;
    defparam RSM.ExtrReset = 0;
    defparam RSM.NumOutputs = 8;

	wire [0:0] tmpOE__IOR_net;
	wire [0:0] tmpIO_0__IOR_net;
	wire [0:0] tmpINTERRUPT_0__IOR_net;
	electrical [0:0] tmpSIOVREF__IOR_net;
	...
	cy_psoc3_pins_v1_10
		...
		IOR
		 (.oe(tmpOE__IOR_net),
		  .y({1'b0}),
		  .fb({Net_297}),
		  .io({tmpIO_0__IOR_net[0:0]}),
		  .siovref(tmpSIOVREF__IOR_net),
		  .interrupt({tmpINTERRUPT_0__IOR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [7:0] tmpOE__Dta_net;
	wire [7:0] tmpIO_7__Dta_net;
	wire [0:0] tmpINTERRUPT_0__Dta_net;
	electrical [0:0] tmpSIOVREF__Dta_net;
	...
	cy_psoc3_pins_v1_10
		...
		Dta
		 (.oe(tmpOE__Dta_net),
		  .y({Net_414[7:0]}),
		  .fb({datain[7:0]}),
		  .io({tmpIO_7__Dta_net[7:0]}),
		  .siovref(tmpSIOVREF__Dta_net),
		  .interrupt({tmpINTERRUPT_0__Dta_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dta_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_533, Net_533, Net_533, Net_533, Net_533, Net_533, Net_533, Net_533} : {Net_533, Net_533, Net_533, Net_533, Net_533, Net_533, Net_533, Net_533};

    // -- LUT LUT_1 start --
    if (1)
    begin : LUT_1
        reg [6:0] tmp__LUT_1_reg;
        wire [4:0] tmp__LUT_1_ins;
        assign tmp__LUT_1_ins = {Net_336,Net_297,Net_343,adl[1],adl[0]};
        always @(tmp__LUT_1_ins)
        begin
            case (tmp__LUT_1_ins)
                5'b00000 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00001 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00010 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00011 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00100 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00101 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00110 :  tmp__LUT_1_reg = 7'b0000000;
                5'b00111 :  tmp__LUT_1_reg = 7'b0000000;
                5'b01000 :  tmp__LUT_1_reg = 7'b0000000;
                5'b01001 :  tmp__LUT_1_reg = 7'b0000000;
                5'b01010 :  tmp__LUT_1_reg = 7'b0000000;
                5'b01011 :  tmp__LUT_1_reg = 7'b0000000;
                5'b01100 :  tmp__LUT_1_reg = 7'b0001000;
                5'b01101 :  tmp__LUT_1_reg = 7'b0010000;
                5'b01110 :  tmp__LUT_1_reg = 7'b0100000;
                5'b01111 :  tmp__LUT_1_reg = 7'b1000000;
                5'b10000 :  tmp__LUT_1_reg = 7'b0000000;
                5'b10001 :  tmp__LUT_1_reg = 7'b0000000;
                5'b10010 :  tmp__LUT_1_reg = 7'b0000000;
                5'b10011 :  tmp__LUT_1_reg = 7'b0000000;
                5'b10100 :  tmp__LUT_1_reg = 7'b0000001;
                5'b10101 :  tmp__LUT_1_reg = 7'b0000011;
                5'b10110 :  tmp__LUT_1_reg = 7'b0000101;
                5'b10111 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11000 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11001 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11010 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11011 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11100 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11101 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11110 :  tmp__LUT_1_reg = 7'b0000000;
                5'b11111 :  tmp__LUT_1_reg = 7'b0000000;
            endcase
        end
        assign {Net_464,Net_450,Net_498,Net_428,Net_330[1],Net_330[0],Net_322} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --

    CyControlReg_v1_80 RSU (
        .clock(1'b0),
        .control_0(Net_359),
        .control_1(Net_360),
        .control_2(Net_361),
        ...
        .control_6(Net_365),
        .control_7(Net_366),
        .control_bus(Net_423[7:0]),
        .reset(1'b0));
    defparam RSU.Bit0Mode = 0;
    defparam RSU.Bit1Mode = 0;
    defparam RSU.Bit2Mode = 0;
    defparam RSU.Bit3Mode = 0;
    defparam RSU.Bit4Mode = 0;
    defparam RSU.Bit5Mode = 0;
    defparam RSU.Bit6Mode = 0;
    defparam RSU.Bit7Mode = 0;
    defparam RSU.BitValue = 127;
    defparam RSU.BusDisplay = 1;
    defparam RSU.ExtrReset = 0;
    defparam RSU.NumOutputs = 8;

    CyControlReg_v1_80 RRD (
        .clock(1'b0),
        .control_0(Net_370),
        .control_1(Net_371),
        .control_2(Net_372),
        ...
        .control_6(Net_376),
        .control_7(Net_377),
        .control_bus(Net_378[7:0]),
        .reset(1'b0));
    defparam RRD.Bit0Mode = 0;
    defparam RRD.Bit1Mode = 0;
    defparam RRD.Bit2Mode = 0;
    defparam RRD.Bit3Mode = 0;
    defparam RRD.Bit4Mode = 0;
    defparam RRD.Bit5Mode = 0;
    defparam RRD.Bit6Mode = 0;
    defparam RRD.Bit7Mode = 0;
    defparam RRD.BitValue = 0;
    defparam RRD.BusDisplay = 1;
    defparam RRD.ExtrReset = 0;
    defparam RRD.NumOutputs = 8;

    CyStatusReg_v1_90 RCU (
        .clock(Net_380),
        .intr(Net_381),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(datain[7:0]));
    defparam RCU.Bit0Mode = 1;
    defparam RCU.Bit1Mode = 1;
    defparam RCU.Bit2Mode = 1;
    defparam RCU.Bit3Mode = 1;
    defparam RCU.Bit4Mode = 1;
    defparam RCU.Bit5Mode = 1;
    defparam RCU.Bit6Mode = 1;
    defparam RCU.Bit7Mode = 1;
    defparam RCU.BusDisplay = 1;
    defparam RCU.Interrupt = 0;
    defparam RCU.MaskValue = 0;
    defparam RCU.NumInputs = 8;

    CyStatusReg_v1_90 ROD (
        .clock(Net_474),
        .intr(Net_392),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(datain[7:0]));
    defparam ROD.Bit0Mode = 1;
    defparam ROD.Bit1Mode = 1;
    defparam ROD.Bit2Mode = 1;
    defparam ROD.Bit3Mode = 1;
    defparam ROD.Bit4Mode = 1;
    defparam ROD.Bit5Mode = 1;
    defparam ROD.Bit6Mode = 1;
    defparam ROD.Bit7Mode = 1;
    defparam ROD.BusDisplay = 1;
    defparam ROD.Interrupt = 0;
    defparam ROD.MaskValue = 0;
    defparam ROD.NumInputs = 8;

    CyStatusReg_v1_90 RST (
        .clock(Net_467),
        .intr(Net_403),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(datain[7:0]));
    defparam RST.Bit0Mode = 1;
    defparam RST.Bit1Mode = 1;
    defparam RST.Bit2Mode = 1;
    defparam RST.Bit3Mode = 1;
    defparam RST.Bit4Mode = 1;
    defparam RST.Bit5Mode = 1;
    defparam RST.Bit6Mode = 1;
    defparam RST.Bit7Mode = 1;
    defparam RST.BusDisplay = 1;
    defparam RST.Interrupt = 0;
    defparam RST.MaskValue = 0;
    defparam RST.NumInputs = 8;

    // -- Mux start --
    if (1)
    begin : mux_2
        reg [7:0] tmp__mux_2_reg;
        always @(Net_255 or Net_423 or Net_378 or Net_425 or Net_330)
        begin
            case (Net_330[1:0])
                2'b00 :  tmp__mux_2_reg = Net_255[7:0];
                2'b01 :  tmp__mux_2_reg = Net_423[7:0];
                2'b10 :  tmp__mux_2_reg = Net_378[7:0];
                2'b11 :  tmp__mux_2_reg = Net_425[7:0];
            endcase
        end
        assign Net_531[7:0] = tmp__mux_2_reg;
    end
    // -- Mux end --

    assign Net_425[7:0] = 8'h5A;

    cy_UDB_clockenable_v1_0 UDBClk_RCM (
        .clock_in(Net_428),
        .clock_out(Net_413),
        .enable(Net_429));
    defparam UDBClk_RCM.ClockOutSync = 1;

    assign Net_429 = 1'h1;

    cy_UDB_clockenable_v1_0 UDBClk_RCU (
        .clock_in(Net_498),
        .clock_out(Net_380),
        .enable(Net_437));
    defparam UDBClk_RCU.ClockOutSync = 1;

    cy_UDB_clockenable_v1_0 UDBClk_ROD (
        .clock_in(Net_450),
        .clock_out(Net_474),
        .enable(Net_440));
    defparam UDBClk_ROD.ClockOutSync = 1;
    ...
    cy_UDB_clockenable_v1_0 UDBClk_RST (
        .clock_in(Net_464),
        .clock_out(Net_467),
        .enable(Net_466));
    defparam UDBClk_RST.ClockOutSync = 1;
    ...
    assign Net_513 = Net_322 & Net_330[1] & Net_517;


    assign Net_517 = ~Net_330[0];

    // -- Mux start --
    if (1)
    begin : mux_3
        reg [7:0] tmp__mux_3_reg;
        always @(Net_531 or busdata or busout)
        begin
            case (busout)
                1'b0 :  tmp__mux_3_reg = Net_531[7:0];
                1'b1 :  tmp__mux_3_reg = busdata[7:0];
            endcase
        end
        assign Net_414[7:0] = tmp__mux_3_reg;
    end
    // -- Mux end --


    assign Net_533 = busout | Net_322;

    CyControlReg_v1_80 BusDta (
        .clock(1'b0),
        .control_0(Net_545),
        .control_1(Net_542),
        .control_2(Net_543),
        ...
        .control_6(Net_548),
        .control_7(Net_549),
        .control_bus(busdata[7:0]),
        .reset(1'b0));
    defparam BusDta.Bit0Mode = 0;
    defparam BusDta.Bit1Mode = 0;
    defparam BusDta.Bit2Mode = 0;
    defparam BusDta.Bit3Mode = 0;
    defparam BusDta.Bit4Mode = 0;
    defparam BusDta.Bit5Mode = 0;
    defparam BusDta.Bit6Mode = 0;
    defparam BusDta.Bit7Mode = 0;
    defparam BusDta.BitValue = 0;
    defparam BusDta.BusDisplay = 1;
    defparam BusDta.ExtrReset = 0;
    defparam BusDta.NumOutputs = 8;

	wire [0:0] tmpOE__MAP1_net;
	wire [0:0] tmpFB_0__MAP1_net;
	wire [0:0] tmpINTERRUPT_0__MAP1_net;
	electrical [0:0] tmpSIOVREF__MAP1_net;
	...
	cy_psoc3_pins_v1_10
		...
		MAP1
		 (.oe(tmpOE__MAP1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAP1_net[0:0]}),
		  .io({Net_562}),
		  .siovref(tmpSIOVREF__MAP1_net),
		  .interrupt({tmpINTERRUPT_0__MAP1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MAP1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__nWAIT_net;
	wire [0:0] tmpFB_0__nWAIT_net;
	wire [0:0] tmpIO_0__nWAIT_net;
	wire [0:0] tmpINTERRUPT_0__nWAIT_net;
	electrical [0:0] tmpSIOVREF__nWAIT_net;
	...
	cy_psoc3_pins_v1_10
		...
		nWAIT
		 (.oe(tmpOE__nWAIT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__nWAIT_net[0:0]}),
		  .io({tmpIO_0__nWAIT_net[0:0]}),
		  .siovref(tmpSIOVREF__nWAIT_net),
		  .interrupt({tmpINTERRUPT_0__nWAIT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__nWAIT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_673 = Net_572 | Net_139;
    ...
    CyStatusReg_v1_90 ADH_Reg (
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_643[7:0]));
    defparam ADH_Reg.Bit0Mode = 0;
    defparam ADH_Reg.Bit1Mode = 0;
    defparam ADH_Reg.Bit2Mode = 0;
    defparam ADH_Reg.Bit3Mode = 0;
    defparam ADH_Reg.Bit4Mode = 0;
    defparam ADH_Reg.Bit5Mode = 0;
    defparam ADH_Reg.Bit6Mode = 0;
    defparam ADH_Reg.Bit7Mode = 0;
    defparam ADH_Reg.BusDisplay = 1;
    defparam ADH_Reg.Interrupt = 0;
    defparam ADH_Reg.MaskValue = 0;
    defparam ADH_Reg.NumInputs = 8;

    CyStatusReg_v1_90 DT_Reg (
        .clock(Net_607),
        .intr(Net_624),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_602[7:0]));
    defparam DT_Reg.Bit0Mode = 0;
    defparam DT_Reg.Bit1Mode = 0;
    defparam DT_Reg.Bit2Mode = 0;
    defparam DT_Reg.Bit3Mode = 0;
    defparam DT_Reg.Bit4Mode = 0;
    defparam DT_Reg.Bit5Mode = 0;
    defparam DT_Reg.Bit6Mode = 0;
    defparam DT_Reg.Bit7Mode = 0;
    defparam DT_Reg.BusDisplay = 1;
    defparam DT_Reg.Interrupt = 0;
    defparam DT_Reg.MaskValue = 0;
    defparam DT_Reg.NumInputs = 8;

    CyStatusReg_v1_90 ADL_Reg (
        .clock(Net_648),
        .intr(Net_653),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_654[7:0]));
    defparam ADL_Reg.Bit0Mode = 0;
    defparam ADL_Reg.Bit1Mode = 0;
    defparam ADL_Reg.Bit2Mode = 0;
    defparam ADL_Reg.Bit3Mode = 0;
    defparam ADL_Reg.Bit4Mode = 0;
    defparam ADL_Reg.Bit5Mode = 0;
    defparam ADL_Reg.Bit6Mode = 0;
    defparam ADL_Reg.Bit7Mode = 0;
    defparam ADL_Reg.BusDisplay = 1;
    defparam ADL_Reg.Interrupt = 0;
    defparam ADL_Reg.MaskValue = 0;
    defparam ADL_Reg.NumInputs = 8;

    // -- DFF Start --
    reg [7:0] cydff_1;
    always @(posedge Net_691)
    begin
        cydff_1 <= datain[7:0];
    end
    assign Net_602[7:0] = cydff_1;
    // -- DFF End --
    ...
    // -- DFF Start --
    reg [7:0] cydff_2;
    always @(posedge Net_674)
    begin
        cydff_2 <= adl[7:0];
    end
    assign Net_654[7:0] = cydff_2;
    // -- DFF End --
